 ...
 * @author Rafael Math
 */
public abstract class Car implements TrafficObject
{
   ...
   protected CarModelLoader carModel;
    ...
    protected float pointOffSet = 20;
    
    protected boolean isCruiseControl = false;
    protected boolean isAdaptiveCruiseControl = false;
    protected boolean isCancle = false;
    protected boolean isLaneKeeping = false;
    protected boolean temperalLaneKeepingFlag = false;
    protected boolean isLeftLaneChange = false;
    protected boolean isRightLaneChange = false;
	protected boolean overTakeFlag = false;
	protected boolean isAutoLaneChanging = false;
    ...
    protected boolean hudFlag = false;
    
    public static int sAutoSteer=0;
	public static int sAutoGear=0;
	public static int sSpeed=0;
	public static int sRPM=750;
	public static int sGear=0;
	public static int sSteer=0;
	public static int sOdometer=0;
...
//   }
   ...
   public void setAutoLaneChangeFlag(boolean flag){
	   this.isAutoLaneChanging = flag;
   ...
   protected void showEngineStatusMessage(boolean engineOn) 
   {
      if(engineOn)
      {
    	  ...
    	  //Hud.getMessageBox().addMessage("Engine on", 2);
      }
      else
      {
    	  //PanelCenter.getMessageBox().addMessage("Engine off. Press 'e' to start.", 0);
    	  //Hud.getMessageBox().addMessage("Engine off. Press 'e' to start.", 0);
      }
   }
   ...
   public void setTargetSpeed(float speeStorage) {
		this.targetSpeedCruiseControl = speeStorage;
	}
   ...
   public void setLaneKeepingFlag(boolean isLaneKeeping) 
   {
      this.isLaneKeeping = isLaneKeeping;
   }
   
   public void setTemperalLaneKeepingFlag(boolean temperalLaneKeepingFlag) 
   {
      this.temperalLaneKeepingFlag = temperalLaneKeepingFlag;
   }
   
   public boolean isTemperalLaneKeepingFlag() 
   {
      return this.temperalLaneKeepingFlag;
   }
   
   public boolean isAutoLaneChange(){
	   return this.isAutoLaneChanging;
   }
   
   public void resumeCruiseControl(boolean isCruiseControl)
   {
      this.isCruiseControl = isCruiseControl;
   }
   
   public void setLeftLaneChange(boolean isLaneChange)
   {
      this.isLeftLaneChange = isLaneChange;
   }
   
   public void setRightLaneChange(boolean isLaneChange)
   {
      this.isRightLaneChange = isLaneChange;
   }
   

   public void setAdaptiveCruiseControl(boolean isAdaptiveCruiseControl) 
   {
      this.isAdaptiveCruiseControl = isAdaptiveCruiseControl;
   }
   ...
   public boolean isLaneKeepingFlag() 
   {
   ...
   {
      return isAdaptiveCruiseControl;
   }
   
   public boolean isLeftLaneChange()
   {
      return isLeftLaneChange;
   }
   
   public boolean isRightLaneChange()
   {
      return isRightLaneChange;
   }
   
   public void setOverTake(boolean overTake){
	   overTakeFlag = overTake;
   }
   
   public void setSpeedUpFlag(boolean speedUp) 
   {
      this.speedUp = speedUp;
   }
   
   public void setSpeedDownFlag(boolean speedDown) 
   {
